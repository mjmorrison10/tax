  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          sx={{ color: "text.secondary", textAlign: { xs: "right", sm: null } }}
        >
          {n.title}
        </Typography>
      </AccordionSummary>
      ...
      >
        ...
        {n.resolve2 && <Typography variant="body">{n.resolve2}</Typography>}
        {n.resolve3 && <Typography variant="body">{n.resolve3}</Typography>}
      </AccordionDetails>
    </Accordion>
  );
}
